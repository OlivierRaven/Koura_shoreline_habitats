...
# Path handling - works both interactively and during render
if (interactive()) {
...
exc_file_dir <- file.path(root_dir, "data/raw/Natural_habitat.xlsx")
der_data_dir <- file.path(root_dir, "data/derived")
fig_dir      <- file.path(root_dir, "outputs")
