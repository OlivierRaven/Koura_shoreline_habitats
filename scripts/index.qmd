...
#| fig-height: 4
#| dpi: 300
#| fig-cap: "Fig. S2 Raw relationships between significant habitat predictors and kōura CPUE (upper panels) and BPUE (lower panels) at sites where kōura were present. Points represent observed values at individual sites. Temperature, pH, and emergent native vegetation cover are shown for CPUE; pH and emergent native vegetation cover are shown for BPUE."
