...
#| fig-height: 4
#| dpi: 300
#| fig-cap: "Fig. S2 Raw relationships between kōura CPUE and BPUE and significant habitat predictors. Points show observed values at individual sites."
...
M_C_data %>%
  ...
  summarise(n = n(),
            ...
            mean_CPUE = mean(Weighted_CPUE_Kōura, na.rm = TRUE),
            mean_BPUE = mean(Weighted_BPUE_Kōura, na.rm = TRUE))
