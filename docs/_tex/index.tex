...
composition are summarised in Table 1.All five lakes have populations of
kōura, and brown bullhead catfish was present in Lakes Rotorua and
...
implemented with the mgcv package in R (\citeproc{ref-Wood2004}{Wood,
2004}, \citeproc{ref-Wood2017}{2017}). To reduce multicollinearity,
predictors were screened using Variance Inflation Factors (VIFs)
calculated from linear models fitted to the fixed-effect design matrix.
A conservative threshold of VIF \textgreater{} 5 was applied
...
influence of temperature (\emph{p} = \textless0.001), as significant
...
and negative influence of temperature (\emph{p} = 0.019) and emergent
native macrophytes (\emph{p} = \textless0.001) as significant smooth
predictors (Figure~\ref{fig-cpue-hurdle} a). The lake identity random
effect was not significant (\emph{p} = 0.482), indicating minimal
...
explained 26 \% of the deviance (adj. R² = 0.141). As the full model is
...
targeted placement of artificial reefs in areas already used by
freshwater crayfish (\citeproc{ref-Johnsen2008}{Johnsen \& Taugbøl,
2008}), may help support the persistence and local recovery of
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0427}}
  >{\raggedright\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.1368}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0812}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0940}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0897}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0641}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0769}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0598}}
  >{\raggedright\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0598}}
  >{\raggedright\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0598}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0427}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0427}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0427}}
...
Polymictic & Eutrophic & 0.0 & 82.8 & 17.2 & 0.0 \\
Rotoiti & 15/01/2025 (12) & 34 & 61 & 123.7 & 31.5 & 124.0 & 279 &
Stratified & Mesotrophic & 0.0 & 68.5 & 21.8 & 9.7 \\
Rotoehu & 10/12/2024 (12) & 8 & 40 & 49.2 & 8.0 & 13.5 & 295 &
Polymictic & Eutrophic & 3.3 & 91.2 & 1.7 & 3.8 \\
Rotomā & 6/11/2024 (12) & 11 & 24 & 27.8 & 36.9 & 83.0 & 316 &
Stratified & Oligotrophic & 0.0 & 62.0 & 17.7 & 20.4 \\
Ōkāreka & 31/10/2024 (10), 22/01/2025 (2) & 3 & 11 & 19.6 & 20.0 & 33.5
& 355 & Stratified & Mesotrophic & 8.9 & 45.1 & 20.2 & 25.8 \\
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-latex/analysis-fig-raw-data-all-predictors-output-1.png}}
...
\textsubscript{Source:
\href{https://OlivierRaven.github.io/Koura_shoreline_habitats/analysis-preview.html\#cell-fig-raw-data-all-predictors}{Analysis
Notebook}}
...
(\emph{ameiurus nebulosus}) in lake taupo}. Master of Science thesis,
...
Berg, A. Nielsen, H. J. Skaug, M. Mächler, \& B. M. Bolker, 2017.
{glmmTMB} balances speed and flexibility among packages for
zero-inflated generalized linear mixed modeling. The R Journal 9:
378--400. \url{https://doi.org/10.32614/RJ-2017-066}.
...
distribution and movements of brown bullhead (\emph{ameiurus nebulosus}
lesueur 1819) in motuoapa bay, southern lake taupo, {New Zealand}}. In
Thorstad, E. B., I. A. Fleming, \& T. F. Næsje (eds) Aquatic telemetry.
Springer Netherlands. pp. 129--135.
...
Hamilton, D., C. McBride, \& T. Uraoka, 2005. Lake rotoiti fieldwork and
...
(decapoda, astacidea). Brill. Crustaceana 82: 1495--1507.
...
New Zealand Journal of Marine and Freshwater Research 4: 278--291.
...
Springer Science; Business Media LLC. Biological Invasions 28:
...
Island, New Zealand}. Fisheries Research 168: 35--46.
...
{New Zealand}. New Zealand Journal of Marine and Freshwater Research 43:
713--722. \url{https://doi.org/10.1080/00288330909510036}.
...
(k{ō}ura, \emph{paranephrops planifrons}) population characteristics in
seven {Te Arawa} ({Rotorua}) lakes, {North Island, New Zealand}. Marine
and Freshwater Research 66: 631--643.
...
stream. New Zealand Journal of Marine and Freshwater Research 43:
689--700. \url{https://doi.org/10.1080/00288330909510034}.
...
gauging weir. Management of Biological Invasions 4: 273--282.
