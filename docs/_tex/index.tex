...
characteristics (\textbf{?@tbl-env-fish-summary}). Physical habitat
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.1020}}
  >{\raggedright\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.1837}}
  >{\raggedright\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.0918}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.0510}}
...
\caption{\label{tbl-env-fish-summary-static}Distribution of
environmental and biotic variables measured at littoral sampling sites
across five Te Arawa lakes in the Rotorua region of Aotearoa New
Zealand.}
...
{New Zealand}}. In Thorstad, E. B., I. A. Fleming, \& T. F. Næsje (eds)
Aquatic telemetry. Springer Netherlands. pp. 129--135.
