...
ggsave(filename = file.path(fig_dir, "final_p_occ_smooths.png"), plot = top_row, width = 180, height = 50, units = "mm", dpi = 1200)

ggsave(filename = file.path(fig_dir, "Calibration_plot_occ.png"), plot = bottom_row, width = 180, height = 80, units = "mm", dpi = 1200)
