...
# ---- unit lookup from the raw Monitoring_data sheet ----
# Monitoring_data uses Parameter + Unit; your summary uses Variable names.
# Create a mapping from your Variable names -> Monitoring_data$Parameter values.
...
knitr::kable(
  EnvBio_summary_table,
  caption = "Table 1. Summary statistics (n, mean, median, range, and 95% confidence intervals) for environmental variables and fish presence across lakes.",
  digits = 2,
