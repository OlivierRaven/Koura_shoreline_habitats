...
packages <- c("rstatix", "multcompView","brglm2","patchwork", "gratia","pROC","caret", "mgcv","tidyr","purrr", "corrplot","glmmTMB", "performance","tibble", "tidyverse", "dplyr","writexl", "readxl")
...
# 4b. Fish presence: mean (proportion) and SEM per lake (site-level)
