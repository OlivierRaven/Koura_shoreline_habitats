...
- **title:** Kōura  and their shoreline habitats: Understanding natural lake habitat preferences of freshwater crayfish (Paranephrops planifrons) in New Zealand lakes
...
```{r fig.width=14, fig.height=10, dpi=100, echo=FALSE, message=FALSE, warning=FALSE}
...
final_plot_occupancy <- patchwork::wrap_plots(
  list(  as_plot(p_occ_smooths),
    as_plot(p_occ_param),
    as_plot(p_pres_roc),
    as_plot(Calibration_plot_occ)),
  ncol = 2,  nrow = 2)

final_plot_occupancy

ggsave(file.path(fig_dir, "Occupancy_panels.png"),final_plot_occupancy, width  = 14,height = 10,dpi    = 300)
...
ggsave(
  file.path(fig_dir, "CPUE_panel_positives.png"),
  CPUE_panel_positives,
  width  = 14,
  height = 5,
  dpi    = 300
...
ggsave(
  file.path(fig_dir, "BPUE_panel_positives.png"),
  BPUE_panel_positives,
  width  = 10,
  height = 5,
  dpi    = 300
...
ggsave(file.path(fig_dir, "p_occ_smooths.png"),       p_occ_smooths, width  = 10, height = 5, dpi    = 300)
ggsave(file.path(fig_dir, "p_pres_roc.png"),          p_pres_roc, width  = 10, height = 5, dpi    = 300)
ggsave(file.path(fig_dir, "Calibration_plot_occ.png"),Calibration_plot_occ, width  = 10, height = 5, dpi    = 300)

ggsave(file.path(fig_dir, "p_cpue_pos_smooths.png"),  p_cpue_pos_smooths, width  = 10, height = 5, dpi    = 300)
ggsave(file.path(fig_dir, "p_cpue_pos_scatter.png"),  p_cpue_pos_scatter, width  = 10, height = 5, dpi    = 300)

ggsave(file.path(fig_dir, "p_BPUE_pos_smooths.png"),  p_BPUE_pos_smooths, width  = 10, height = 5, dpi    = 300)
ggsave(file.path(fig_dir, "p_BPUE_pos_scatter.png"),  p_BPUE_pos_scatter, width  = 10, height = 5, dpi    = 300)
