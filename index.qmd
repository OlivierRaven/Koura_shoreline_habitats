...
lengt_weight_plot <- ggplot(Fish_data |> dplyr::filter(is_koura),
  aes(Length_mm, Predicted_weight, col = Weight_source)) +
...
plot_koura_stats <- function(data, y_var, y_label,
  ...
  if (type == "continuous") {
    ...
    # presence summary + binomial CI per lake (exact)
